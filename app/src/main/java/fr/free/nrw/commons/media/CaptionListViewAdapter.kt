...
class CaptionListViewAdapter(private val captions: List<Caption>) : BaseAdapter() {
    ...
    override fun getView(i: Int, view: View?, viewGroup: ViewGroup): View {
        ...
        val captionLanguageTextView: TextView = captionLayout.findViewById(R.id.caption_language_textview)
        val captionTextView: TextView = captionLayout.findViewById(R.id.caption_text)
